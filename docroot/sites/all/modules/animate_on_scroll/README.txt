...
Animate On Scroll Library. (Check demo at: http://michalsnik.github.io/aos/)
  ...
  2) Copy aos library in your libraries directory, so aos.js will be located
     at /sites/all/libraries/aos/dist/aos.js.


Installation
============
  1) Copy the 'aos' module into your Drupal sites/all/modules and enable it.
  2) As this module provides the integration of AOS library, to get the 
     ...
     like <div data-aos="animation_name">  in your html.
     
     e.g. <div data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
