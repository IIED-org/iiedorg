  ...
  try { google.load("feeds", "1"); 
     ...
     function feedLoaded(result) {
      if (!result.error && result.feed.entries.length > 0) {
        ...
        aa.setAttribute("href","http://pubs.iied.org/search.php?a=" + document.getElementById('page-title').innerHTML);
        diva.appendChild(aa);
    ...
    function OnLoad() {
      var feed = new google.feeds.Feed("http://pubs.iied.org/searchrss2.php?a=" + document.getElementById('page-title').innerHTML);
